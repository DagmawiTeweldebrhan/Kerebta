...
class _SignUpScreenState extends State<SignUpScreen> with TickerProviderStateMixin {
  ...
  List<String> _categories = [
    'Musician', 'Filmmaker', 'Photographer', 'Poet', 'Producer',
  ];
  List<String> _categoriesAm = [
    'ሙዚቀኛ', 'ፊልም ሰሪ', 'ፎቶግራፈር', 'ገጣሚ', 'ፕሮዲውሰር',
  ];
  ...
  void initState() {
    ...
    for (final fn in [_nameFocus, _usernameFocus, _authFocus, _passwordFocus, _bioFocus]) {
      fn.addListener(() => setState(() {
        _activeFieldIndex = [_nameFocus, _usernameFocus, _authFocus, _passwordFocus, _bioFocus].indexOf(fn);
  ...
  Widget build(BuildContext context) {
    ...
    final subText = isLight ? const Color(0xFF1A1A1A).withOpacity(0.7) : AppColors.white.withOpacity(0.7);
                      ...
                      child: LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          return Stack(
                            children: [
                              // Dormant spine
                              Container(width: 0.8, height: totalH, color: gold.withOpacity(0.15)),
                              ...
                              AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: gold.withOpacity(0.3 + _spineGlowController.value * 0.3),
                ...
                children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Row(mainAxisSize: MainAxisSize.min, children: [
                              ...
                              Text(isAmharic ? "EN" : "አማ", style: GoogleFonts.poppins(color: textColor, fontSize: 14.0, fontWeight: FontWeight.w600)),
                            ]),
                          ),
                        ),
                      ],
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      padding: const EdgeInsets.only(left: 48.0, right: 24.0), // Left offset for spine
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            widget.role == UserRole.creator
                                ? (isAmharic ? "ስቱዲዮዎን ይጀምሩ።" : "Start Your Studio.")
                                : (isAmharic ? "ማህበረሰቡን ይቀላቀሉ።" : "Join the Community."),
                          ...
                          // FULL NAME
                          _buildField(
                            index: 0, focusNode: _nameFocus, controller: _nameController,
                            hint: isAmharic ? "ስምዎን ያስገቡ" : "What should we call you?",
                            gold: gold, hint2: hint, textColor: textColor, fieldBg: fieldBg, isLight: isLight,
                          ),
                          const SizedBox(height: 16.0),

                          // USERNAME with @ prefix
                          _buildField(
                            index: 1, focusNode: _usernameFocus, controller: _usernameController,
                            hint: isAmharic ? "የተጠቃሚ ስም" : "Username",
                            gold: gold, hint2: hint, textColor: textColor, fieldBg: fieldBg, isLight: isLight,
                            prefix: Text("@", style: GoogleFonts.poppins(color: gold, fontSize: 18.0, fontWeight: FontWeight.w700)),
                          ),
                          const SizedBox(height: 16.0),

                          // PHONE/EMAIL
                          _buildField(
                            index: 2, focusNode: _authFocus, controller: _authController,
                            hint: isAmharic ? "ስልክ ቁጥር ወይም ኢሜይል" : "Phone Number or Email",
                            gold: gold, hint2: hint, textColor: textColor, fieldBg: fieldBg, isLight: isLight,
                          ),
                          if (_authController.text.isNotEmpty && !_isAuthValid)
                            Padding(
                              ...
                              child: Text(
                                isAmharic ? "ትክክለኛ ስልክ ቁጥር ወይም ኢሜይል ያስገቡ" : "Enter a valid phone number or email",
                          ...
                          GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.calendar_today_rounded, color: gold.withOpacity(0.7), size: 20.0),
                                  const SizedBox(width: 12.0),
                                  Text(
                                    _birthdate != null
                                    ...
                                    style: GoogleFonts.poppins(
                                      color: _birthdate != null ? textColor : hint,
                          ...
                          // PASSWORD
                          _buildField(
                            index: 4, focusNode: _passwordFocus, controller: _passwordController,
                            hint: isAmharic ? "የይለፍ ቃል" : "Password",
                            gold: gold, hint2: hint, textColor: textColor, fieldBg: fieldBg, isLight: isLight,
                            obscure: !_showPassword,
                            suffix: IconButton(
                              icon: Icon(_showPassword ? Icons.visibility_off_rounded : Icons.visibility_rounded, color: gold.withOpacity(0.7)),
                          ...
                          if (widget.role == UserRole.creator) ...[
                            ...
                            Text(
                              ...
                              style: GoogleFonts.poppins(color: subText, fontSize: 16.0, fontWeight: FontWeight.w600),
                            ),
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, i) {
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: AnimatedContainer(
                                          ...
                                          decoration: BoxDecoration(
                                            color: fieldBg,
                                            borderRadius: BorderRadius.circular(20.0),
                                            border: Border.all(color: gold.withOpacity(0.4), width: 0.5),
                                          ),
                                  ...
                                  return Padding(
                                    padding: EdgeInsets.only(left: i == 0 ? 0 : 10.0),
                                    child: GestureDetector(
                                      ...
                                      child: AnimatedContainer(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          borderRadius: BorderRadius.circular(20.0),
                                          border: Border.all(color: gold.withOpacity(selected ? 1.0 : 0.4), width: 0.5),
                                        ),
                                        child: Text(
                                          isAmharic ? _categoriesAm[i] : _categories[i],
                                          style: GoogleFonts.poppins(
                                            color: selected ? AppColors.black : textColor,
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _idUploaded ? gold.withOpacity(0.1) : Colors.transparent,
                                  borderRadius: BorderRadius.circular(12.0),
                                  border: Border.all(
                                    color: _idUploaded ? gold : gold.withOpacity(0.5), 
                                    width: 1.0, 
                                ...
                                child: Column(
                                  children: [
                                    if (_idUploading)
                                      SizedBox(width: 32, height: 32, child: CircularProgressIndicator(color: gold, strokeWidth: 2))
                                    else
                                      Icon(_idUploaded ? Icons.check_circle_outline : Icons.cloud_upload_outlined, color: _idUploaded ? gold : gold.withOpacity(0.6), size: 32.0),
                                    const SizedBox(height: 8.0),
                                    Text(
                                      _idUploaded 
                                          ? (isAmharic ? "መታወቂያ በተሳካ ሁኔታ ገብቷል" : "ID Uploaded Successfully")
                                          : (isAmharic ? "ለክፍያ ማረጋገጫ መታወቂያ ያስገቡ" : "Upload ID for Payout Verification"),
                                      style: GoogleFonts.poppins(
                                    ...
                                    if (!_idUploaded) ...[
                                      ...
                                      Text(
                                        "Telebirr / CBE",
                                        style: GoogleFonts.poppins(color: gold.withOpacity(0.5), fontSize: 12.0, fontWeight: FontWeight.w500),
                                      ),
                                    ]
                                  ],
                                ),
                            ...
                            _buildField(
                              index: 5, focusNode: FocusNode(), controller: _payoutController,
                              hint: isAmharic ? "የክፍያ አካውንት (ለምሳሌ Telebirr)" : "Where should we send your payouts?",
                              gold: gold, hint2: hint, textColor: textColor, fieldBg: fieldBg, isLight: isLight,
                            ),
                            const SizedBox(height: 16.0),
                              ...
                              child: BackdropFilter(
                                ...
                                child: Container(
                                  ...
                                  child: TextField(
                                    ...
                                    focusNode: _bioFocus,
                                    maxLines: 3,
                                    style: GoogleFonts.poppins(color: textColor, fontSize: 16.0, fontWeight: FontWeight.w500),
                                    decoration: InputDecoration(
                                      hintText: isAmharic ? "አጭር የግል መግለጫ ወይም ማህበራዊ ሊንክ" : "Short Bio or Social Link",
                                      hintStyle: GoogleFonts.poppins(color: hint, fontSize: 14.0, fontWeight: FontWeight.w600),
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    color: _agreeTerms ? gold : Colors.transparent,
                                    borderRadius: BorderRadius.circular(6.0),
                                    border: Border.all(color: gold, width: 1.0),
                                  ),
                                  child: _agreeTerms ? const Icon(Icons.check_rounded, size: 16.0, color: Colors.black) : null,
                                ),
                              ),
                              const SizedBox(width: 12.0),
                              Expanded(
                                child: Text(
                                  ...
                                  style: GoogleFonts.poppins(color: subText, fontSize: 14.0, fontWeight: FontWeight.w500),
                                ),
                              ),
                            ],
                          ),
                          ...
                          AnimatedBuilder(
                            ...
                            builder: (context, _) {
                              return Container(
                                width: double.infinity,
                                decoration: _isFormValid ? BoxDecoration(
                                  borderRadius: BorderRadius.circular(30.0),
                                  boxShadow: [
                                    BoxShadow(
                                      color: gold.withOpacity(0.2 + _buttonGlowController.value * 0.15),
                                ...
                                child: ElevatedButton(
                                  onPressed: _isFormValid ? () {
                                    final masked = _authController.text.length > 4
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        isAmharic ? "አካውንት ይፍጠሩ" : "Create Account",
                                        style: GoogleFonts.poppins(fontSize: 18.0, fontWeight: FontWeight.w700, color: AppColors.black),
                                      ),
                                    ],
                                  ),
                                ),
                          ...
                          Center(
                            child: GestureDetector(
                              ...
                              child: RichText(
                                text: TextSpan(
                                  style: GoogleFonts.poppins(fontSize: 16.0, fontWeight: FontWeight.w600, color: subText),
                                  children: [
                                    TextSpan(text: isAmharic ? "አካውንት አለዎት? " : "Already have an account? "),
                                    TextSpan(text: isAmharic ? "ይግቡ" : "Log In", style: TextStyle(color: gold)),
                                  ],
                                ),
                              ),
                            ),
                          ...
                          Center(
                            child: _socialLoading
                              ...
                              : Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () => _handleSocialAuth(context, 'apple'),
                                      child: Icon(Icons.apple, color: textColor.withOpacity(0.5), size: 28.0),
                                    ),
                                    const SizedBox(width: 24.0),
                                    GestureDetector(
                                      onTap: () => _handleSocialAuth(context, 'google'),
                                      child: Icon(Icons.g_mobiledata_rounded, color: textColor.withOpacity(0.5), size: 34.0),
                                    ),
                                  ],
                                ),
                          ),
    ...
    await showDialog(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          ...
          title: Text(isAmharic ? "አዲስ ምድብ ያክሉ" : "Add Custom Category", style: GoogleFonts.poppins(color: textColor, fontWeight: FontWeight.bold, fontSize: 18.0)),
          content: TextField(
            controller: tc,
          ...
          actions: [
            TextButton(
              ...
              child: Text(isAmharic ? "ሰርዝ" : "Cancel", style: GoogleFonts.poppins(color: textColor.withOpacity(0.7))),
            ),
            TextButton(
              onPressed: () {
              ...
              child: Text(isAmharic ? "ያክሉ" : "Add", style: GoogleFonts.poppins(color: gold, fontWeight: FontWeight.bold)),
            ),
          ],
        );
      }
  ...
  Widget _buildField({
    required int index, required FocusNode focusNode, required TextEditingController controller,
    required String hint, required Color gold, required Color hint2, required Color textColor,
    required Color fieldBg, required bool isLight, bool obscure = false, Widget? prefix, Widget? suffix,
  }) {
    return ClipRRect(
      borderRadius: BorderRadius.circular(12.0),
      child: BackdropFilter(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: fieldBg,
            borderRadius: BorderRadius.circular(12.0),
            border: Border.all(color: gold, width: focusNode.hasFocus ? 1.2 : 0.5),
          ),
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: hint,
              hintStyle: GoogleFonts.poppins(color: hint2, fontSize: 16.0, fontWeight: FontWeight.w600),
              border: InputBorder.none,
              contentPadding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 18.0),
              prefixIcon: prefix != null ? Padding(padding: const EdgeInsets.only(left: 16.0, right: 4.0), child: prefix) : null,
