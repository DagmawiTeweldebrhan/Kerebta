...
class _HomeFeedPageState extends State<HomeFeedPage>
  ...
  final List<Map<String, dynamic>> _creators = [
    {
      'creatorId': 'teddy-afro',
      'nickname': 'Teddy Afro',
      'avatarUrl': 'assets/images/creator_teddy_afro.jpg',
      'bannerUrl': 'assets/images/exclusive_sememen.jpg',
      'isVerified': true,
      'followerCount': 2450000,
      'supporterCount': 184200,
      'dmRequestAmount': 1200,
      'accentPrimary': const Color(0xFFD4AF37),
      'accentSecondary': const Color(0xFFFFDF73),
      'gradient': [Color(0xFFD4AF37), Color(0xFFFFDF73)],
    },
    {
      'creatorId': 'aster-aweke',
      'nickname': 'Aster Aweke',
      'avatarUrl': 'assets/images/creator_aster_aweke.jpg',
      'bannerUrl': 'assets/images/exclusive_saba.jpg',
      'isVerified': true,
      'followerCount': 1320000,
      'supporterCount': 97400,
      'dmRequestAmount': 950,
      'accentPrimary': const Color(0xFF1D9BF0),
      'accentSecondary': const Color(0xFF80D0FF),
    ...
    },
    {
      ...
      'bannerUrl': 'assets/images/exclusive_sidama.jpg',
      'isVerified': true,
      'followerCount': 1180000,
      'supporterCount': 81200,
      'dmRequestAmount': 800,
      'accentPrimary': const Color(0xFFE040FB),
      'accentSecondary': const Color(0xFFF3E5F5),
      'gradient': [Color(0xFFE040FB), Color(0xFFF3E5F5)],
    },
    {
      'creatorId': 'zeritu-kebede',
      'nickname': 'Zeritu Kebede',
      'avatarUrl': 'assets/images/creator_zeritu_kebede.jpg',
      'bannerUrl': 'assets/images/exclusive_saba.jpg',
      'isVerified': true,
      'followerCount': 760000,
      'supporterCount': 42100,
      'dmRequestAmount': 700,
      'accentPrimary': const Color(0xFF00E676),
      'accentSecondary': const Color(0xFFB9F6CA),
    ...
    },
    {
      ...
      'supporterCount': 36500,
      'dmRequestAmount': 600,
      'accentPrimary': const Color(0xFFFF5252),
      'accentSecondary': const Color(0xFFFF8A80),
      'gradient': [Color(0xFFFF5252), Color(0xFFFF8A80)],
    },
    {
      'creatorId': 'abinet-agonafer',
      'nickname': 'Abinet Agonafer',
      'avatarUrl': 'assets/images/creator_abinet_agonafer.jpg',
      'bannerUrl': 'assets/images/exclusive_sememen.jpg',
      'isVerified': true,
      'followerCount': 510000,
      'supporterCount': 24100,
      'dmRequestAmount': 500,
      'accentPrimary': const Color(0xFF00B0FF),
      'accentSecondary': const Color(0xFF80D8FF),
  ...
  Widget build(BuildContext context) {
    ...
    final Color secondaryTextColor =
        isDark ? Colors.white.withOpacity(0.7) : const Color(0xFF555555);
    final Color cardBgColor = isDark ? const Color(0xFF1E1E1E) : Colors.white;
    final Color shadowColor =
        isDark ? Colors.black.withOpacity(0.4) : Colors.grey.withOpacity(0.1);
    ...
    return Scaffold(
              ...
              child: SafeArea(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(
                      top: 24.0, bottom: 8.0, left: 12.0, right: 12.0),
                  child: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        icon: Icon(Icons.search,
                            color: primaryTextColor, size: 26.0),
                        onPressed: () {
                        ...
                        children: [
                          Image.asset(
                            ...
                            errorBuilder: (context, error, stackTrace) {
                              ...
                              return const Icon(Icons.stars_rounded,
                                  color: primaryGold, size: 28.0);
                            },
                          ),
      ...
      body: IndexedStack(
        ...
        children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(_isAmharic
                                  ? 'ወደ የኪስ ቦርሳ ገጽ በመሄድ ላይ...'
                                  : 'Routing to Wallet page...'),
                              backgroundColor: primaryGold,
                            ),
                          );
                        },
                            ...
                            builder: (context, currentTheme, _) {
                              ...
                              return GestureDetector(
                                onTap: () {
                                  ...
                                  appThemeMode.value = isCurrentDark
                                      ? ThemeMode.light
                                      : ThemeMode.dark;
                                },
                            ...
                            Positioned(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () => _openCreatorHubByName(
                                        release['creatorName'] as String),
                                    child: Row(
                                      children: [
                                        Container(
                                          width: 20.0,
                      ...
                      TextButton(
                        onPressed: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(_isAmharic
                                  ? 'ሁሉንም በጎ አድራጎት በቅርቡ ይጫናሉ'
                                  : 'Viewing all charities...'),
                              backgroundColor: primaryGold,
                            ),
                          );
                        },
                                  ...
                                  ClipRRect(
                                    ...
                                    child: LinearProgressIndicator(
                                      ...
                                      valueColor:
                                          const AlwaysStoppedAnimation<Color>(
                                        Colors
                                            .green, // Filled using Green for money/charity
                                      ),
                                    ),
                                  ),
                                  const SizedBox(height: 8.0),
          ...
          ProfileTab(isAmharic: _isAmharic),
        ],
      ),
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          ...
          showUnselectedLabels:
              true, // Keep labels persistent and completely readable
          onTap: (index) {
            setState(() {
  ...
  void _openCreatorHub(Map<String, dynamic> creator) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => CreatorHubPage(
          creatorId: creator['creatorId'] as String? ??
              (creator['nickname'] as String)
                  .toLowerCase()
                  .replaceAll(' ', '-'),
          creatorName: creator['nickname'] as String? ?? 'Creator',
          avatarUrl: creator['avatarUrl'] as String? ?? '',
          bannerImageUrl: creator['bannerUrl'] as String? ??
              (creator['avatarUrl'] as String? ?? ''),
          primaryAccent:
              creator['accentPrimary'] as Color? ?? const Color(0xFF1D9BF0),
          secondaryAccent:
              creator['accentSecondary'] as Color? ?? const Color(0xFFD4AF37),
          followerCount: creator['followerCount'] as int? ?? 0,
          supporterCount: creator['supporterCount'] as int? ?? 0,
          dmRequestAmount: creator['dmRequestAmount'] as int? ?? 0,
  ...
  void _openCreatorHubByName(String creatorName) {
    for (final creator in _creators) {
      if (creator['nickname'] == creatorName) {
        _openCreatorHub(creator);
        return;
      }
    }
  }
